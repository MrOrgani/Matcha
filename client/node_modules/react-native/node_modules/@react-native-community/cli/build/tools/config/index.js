...
function loadConfig(projectRoot = process.cwd()) {
  ...
  const finalConfig = [...Object.keys(userConfig.dependencies), ...(0, _findDependencies.default)(projectRoot)].reduce((acc, dependencyName) => {

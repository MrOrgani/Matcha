...
async function unlink(args, ctx) {
  ...
  try {
    ...
    unlinkDependency(ctx.platforms, ctx.project, dependency, packageName, dependencies);
  ...
  Object.keys(ctx.platforms || {}).forEach(platform => {
    ...
    const linkConfig = ctx.platforms[platform] && ctx.platforms[platform].linkConfig && ctx.platforms[platform].linkConfig();
